...
public final class AndroidSchedulers {
    ...
    private static final Scheduler MAIN_THREAD = ReactorAndroidPlugins.initMainThreadScheduler(() -> MainHolder.DEFAULT);
    ...
    public static Scheduler mainThread() {
        return ReactorAndroidPlugins.onMainThreadScheduler(MAIN_THREAD);
    }
