...
===============
 ...
 4.  Update the RxJava version in `reactorandroid/build.gradle` to its latest. (We tell people that we
 ...
 10. Paste the `CHANGELOG.md` contents for this version into a Release on GitHub along with the
     Groovy for depending on the new version (https://github.com/ReactiveX/ReactorAndroid/releases).
